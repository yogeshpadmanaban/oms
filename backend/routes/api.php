...
// Route::group(['middleware' => ['auth:admin']], function() {
    Route::group(['middleware' => 'CORS'], function () {
        ...
        Route::post('/admin/store_dealer', [CreditorController::class, 'store_dealer'])->name('store_dealer');
        Route::post('/admin/dealer_name_check', [CreditorController::class, 'dealer_name_check']);
        Route::get('/admin/dealer_details', [CreditorController::class, 'fetch_dealer_details']);
        Route::get('/admin/edit_dealer/{id}', [CreditorController::class, 'edit_dealer']);
        Route::post('/admin/dealer_delete/{id}', [CreditorController::class, 'delete']);
        Route::post('/admin/dealer_change_status/{id}', [CreditorController::class, 'status_change']);
        Route::post('/admin/dealer_bulk_status_change/{data}', [CreditorController::class, 'bulk_status_change']);
        Route::post('/admin/dealer_multi_delete/{id}', [CreditorController::class, 'multiple_delete']);
